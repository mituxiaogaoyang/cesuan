//因本项目特殊需求（允许时间hour未知），对vant时间表datepicker组件有所改动,本人水平有限，且只是适用于本项目,故记录下来,以防丢失(原文件地址node_modules/vant/es/date_picker/index.js)
      ...
      if (this.type === 'time') {
        ...
        if (this.type === 'datetime') {
          ...
          minute = this.getTrueValue(values[4]);
				...
				if(hour === '不清楚'){
					value = new Date(year+'1', month - 1, date)
				}else{
